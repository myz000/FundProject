...
<thead>
        <tr class="ft_row">
            ...
            <th class="ft_h3">基金名称单拼</th>
            <th class="ft_h">基金名称</th>
            <th class="ft_h">基金类型</th>
            <th class="ft_h">基金名称全拼</th>
            <th class="ft_h">添加</th>
        </tr>
        </thead>
...
<script>
    ...
    callback:function(data,pagination){
     ...
     html+=
        "<tr class='ft_row'>"+
                                                      "<td>"+index+"</td>"+
                                                      "<td><a href='GetFundDetails?fundCode="+d[0]+"' target='_blank'>"+d[0]+"</td>"+
                                                      "<td>"+d[1]+"</td>"+
                                                      "<td><a href='GetFundDetails?fundCode="+d[0]+"' target='_blank'>"+d[2]+"</td>"+
                                                      "<td>"+d[3]+"</td>"+
                                                      "<td>"+d[4]+"</td>"+
                                                      "<td><a href='WriteInvestInfor?fundname="+d[2]+"&fundcode="+d[0]+"'>添加</a></td>"+
                                                  "</tr>";
                                                  }
